 ...
 * RKWebSocket
 *
 * Created by You on January 7, 2015.
 *
...
task ("help", function()
{
    ...
    colorPrint("RKWebSocket - Framework", "bold+green");
    colorPrint("--------------------------------------------------------------------------", "bold+green");
